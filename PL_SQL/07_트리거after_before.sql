...
BEGIN
    ...
    -- -> 원본 테이블에서 UPDATE 혹은 DELETE 된 사용자의 장보 및 기타 정보)
...
CREATE OR REPLACE TRIGGER trg_user_insert
    ...
    FOR EACH ROW
BEGIN
    -- INSERT 예정인 name의 값에서 첫 글자만 substr로 추출 후 뒤에 *을 3개 붙이겠다.
...
BEGIN
    ...
    ELSIF v_total > v_product_total THEN -- 주문 수량이 재고 수량보다 많은 경우
