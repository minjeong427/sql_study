...
VALUES(300, '개발부'); -- ERROR -> 컬럼을 지정하지 않고 값만 주는 경우에는 모든 값을 다 줘야 한다.( NULL 허용 여부 상관없이)

SELECT * FROM departments;

ROLLBACK; -- 실행 시점을 다시 뒤로 되돌리는 키워드

-- INSERT의 두 번째 방법(직접 컬럼을 지정하고 저장, NOT NULL 컬럼을 확인하세요!)
INSERT INTO departments
    (department_id, location_id) -- ERROR -> department_name이 NOT NULL!
VALUES
    (301, 1500);
...
-- UPDATE를 진행할 때는 누구를 수정할지 조건으로 잘 지목해야 합니다.
