...
-- 다음 문장은 서브쿼리가 리턴하는 행이 여러개라서 단일 행 연산자를 사용할 수 없습니다.
...
-- EXISTS 연산자가 1이 조회가 될 때 데이터가 존재한다는 것을 판단하여 employees에서 해단 사원의 모든 정보를 조회.
