...
CREATE SEQUENCE dept2_seq 
    START WITH 1 -- 시작값(기본 값은 증가할 때 최소값, 감소할 때 최대값)
    INCREMENT BY 1 -- 증가값(양수면 증가, 음수면 감소, 기본 값 1)
    MAXVALUE 10 -- 최대값(기본 값은 증가일 때 1027, 감소일 때 -1)
    MINVALUE 1 -- 최소값(기본 값은 증가일 때 1, 감소일 대 -1028)
...
INSERT INTO dept2
VALUES(dept2_seq.NEXTVAL, 'test', 'test', sysdate); -- INSERT 실행 시 시퀀스의 다음 값을 활용.
